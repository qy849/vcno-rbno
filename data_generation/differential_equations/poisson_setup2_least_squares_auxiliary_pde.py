...
if __name__ == '__main__':
    ...
    plt.savefig(os.path.join(train_dataset_path, "q_poisson_setup2.png"), dpi=300, bbox_inches="tight")
    plt.close()
    ...
    plt.savefig(os.path.join(train_dataset_path, "w_poisson_setup2.png"), dpi=300, bbox_inches="tight")
    plt.close()  
    print(f'Plots saved to {train_dataset_path}/q_poisson_setup2.png and {train_dataset_path}/w_poisson_setup2.png')
    ...
    plt.savefig(os.path.join(train_dataset_path, "z1_poisson_setup2.png"), dpi=300, bbox_inches="tight")
    plt.close()
    ...
    plt.savefig(os.path.join(train_dataset_path, "z2_poisson_setup2.png"), dpi=300, bbox_inches="tight")
    plt.close()
