# %% [markdown]
# # FC_PINO two-stage data + physics baseline for `poisson_setup1`
# 
...
model_train_outputs_path = repo_path / 'results/poisson_setup1/model_train_outputs/fc_pino_two_stage_data_physics'
model_test_outputs_path = repo_path / 'results/poisson_setup1/model_test_outputs/fc_pino_two_stage_data_physics'
...
num_data_train = 1000      # N_1: parameter-solution pairs used for supervised data training.
