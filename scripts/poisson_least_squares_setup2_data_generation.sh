...
# bash poisson_least_squares_setup2_data_generation.sh | tee ../logs/poisson_least_squares_setup2_data_generation.log
...
input_probability_measure_config_path="$repo_path/configs/poisson_setup2/config_data/config_input_probability_measure.yaml"
...
poisson_permeability_path="$repo_path/data_generation/probability_measure/poisson_permeability_setup2.py"
poisson_permeability_evaluating_grid_points_path="$repo_path/data_generation/probability_measure/poisson_permeability_setup2_evaluating_grid_points.py"


poisson_least_squares_path="$repo_path/data_generation/differential_equations/poisson_setup2_least_squares.py"
poisson_least_squares_evaluating_grid_points_path="$repo_path/data_generation/differential_equations/poisson_setup2_least_squares_evaluating_grid_points.py"

poisson_least_squares_finer_path="$repo_path/data_generation/differential_equations/poisson_setup2_least_squares_finer.py"
poisson_least_squares_evaluating_grid_points_finer_path="$repo_path/data_generation/differential_equations/poisson_setup2_least_squares_evaluating_grid_points_finer.py"

poisson_least_squares_auxiliary_pde_path="$repo_path/data_generation/differential_equations/poisson_setup2_least_squares_auxiliary_pde.py"
poisson_least_squares_hdiv_h1_pod_basis_path="$repo_path/data_generation/output_reduced_basis/poisson_setup2_least_squares_hdiv_h1_pod_basis.py"
poisson_least_squares_hdiv_h1_reduced_loss_weight_path="$repo_path/data_generation/reduced_loss_weight/poisson_setup2_least_squares_hdiv_h1_reduced_loss_weight.py"
